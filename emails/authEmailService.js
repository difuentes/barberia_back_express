...
export async function sendEmailVerification({name, email, token }) {
    ...
    const info = await transporter.sendMail({
        from: 'BarberApp <cuentas@demilio.com>',
        to: email,
        subject: "BarberApp - Confirma tu cuenta",
        text: "BarberApp - Confirma tu cuenta",
        html: `<p>Hola: ${name}, confirma tu cuenta en BarberApp</p>
